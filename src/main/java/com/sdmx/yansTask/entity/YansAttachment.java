...
@Entity
@Table(name = "Yansattachment", schema="SDMX")
public class YansAttachment {
	private int id;
	...
	public YansAttachment(String newName, String oldName, String contentType,
			Date createDate) {
		super();
