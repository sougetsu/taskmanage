...
@Repository("yansTaskPriceDao")
public class YansTaskPriceDaoImpl extends BaseDaoImpl<YansTaskPrice> implements
		IYansTaskPriceDao {
	@Autowired
	...
	public List<TaskPriceVO> getTaskPriceVO(String id) {
		...
		String sql = "select s.taskpriceid,t.itemid,t.itemname,t.price,t.chargeunit,t.baseprice,s.itemnum,s.itemsum,s.remarks from priceitem t left join (select * from yanstaskprice where yanstaskprice.taskorderid='"
				+ id
