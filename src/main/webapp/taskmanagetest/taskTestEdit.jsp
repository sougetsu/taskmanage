...
<script type="text/javascript">
	...
	function editSubmit(){
		...
		if(submitForm.form('validate')){
    		...
    		$.ajax({
                type: "POST",
                url:'${pageContext.request.contextPath}/taskManageTest/editSubmit',
	...
	$("#editTest_electricId").combotree({
    	onSelect:function(node){
    		$("#editTest_topicNo").val(node.value);
    		$("#editTest_projectName").val(node.annotation);
    	}    
    });
</script>
		...
		<form id="taskOrder_editForm"method="post">
			...
			<table class="tasktableForm" width="95%">
				...
				<tr>
					...
					<td width=174 colspan=2>
						<input id="editTest_electricId" name="electricId" class="easyui-combotree" style="width:330px;height:26px" data-options="url:'${pageContext.request.contextPath}/dictionary/electricList',parentField : 'pid'"
						lines="true" cascadeCheck="false" value="${taskOrder.electricId}"/>
					</td>
					<th width=121 colspan=2>项目名称</th>
					<td width=264 colspan=3>
						<input id="editTest_projectName" name="projectName" readonly="true"  value="${taskOrder.projectName}" style="width:330px;font-size: 12px"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width=174 colspan=2>
						<input id="editTest_topicNo" name="topicNo" readonly="true" style="width:330px;font-size: 12px" value="${taskOrder.topicNo}"/>
					</td>
