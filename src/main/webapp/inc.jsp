...
<!-- upload控件 -->
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/file/jquery.uploadify.v2.1.4.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/file/swfobject.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath}/jslib/file/uploadify.css" type="text/css"></link>
<!-- 引入Highcharts -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/reEasyui.js" charset="utf-8"></script>
