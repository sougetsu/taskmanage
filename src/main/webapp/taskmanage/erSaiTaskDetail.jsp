	...
	function MakeWord(id)
	 {
		$.ajax({
           	type: "POST",
			url : '${pageContext.request.contextPath}/erSaiTaskManage/exportWord',
			data: {orderId : id},
            dataType : 'json',
...
<div data-options="region:'center',border:false" style="position:relative;left:0;top:0;"">
	<div style="width:780px;margin-left: auto;margin-right: auto;>
		<form id="erSai_taskOrder_detailForm"method="post">
			<table id="PrintA" class="tasktableForm" width=100%>
				...
				<tr>
			         <td width=646 colspan=8 style="text-align:center">
			         	<a id="ersai_detail_export" class="l-btn" href="${pageContext.request.contextPath}/erSaiTaskManage/exportWord?orderId=${taskOrder.orderId}" target="_self">
			         		<span class="l-btn-left">
			         			<span class="l-btn-text icon-save l-btn-icon-left" style="padding-left: 20px; ">导出</span>
			         		</span>
			         	</a>
			         	<a id="ersai_detail_close" class="l-btn" href="javascript:void(0);" onclick="closeCurrentTab();return false;">
			         		<span class="l-btn-left">
