...
<script type="text/javascript">
	...
	function editSubmit(){
		var submitForm = $('#taskOrdermdRadiation_EditForm');
		if(submitForm.form('validate')){
    		...
    		$.ajax({
                type: "POST",
                url:'${pageContext.request.contextPath}/taskManagemdRadiation/editSubmit',
...
<div data-options="region:'center',border:false">
	<div align="center" style="margin-top:20px;">
		<form id="taskOrdermdRadiation_EditForm"method="post" enctype="multipart/form-data">
			...
			<table class="tasktableForm" width="95%" border="1"  bordercolor="#B5C0C4" rules="none" style="border-collapse:collapse;">
				...
				<tr>
			         <td colspan=4 style="text-align:center">
			         	<a id="radiation_edit_submit" class="l-btn" href="javascript:void(0);" onclick="javascript:editSubmit()">
			         		<span class="l-btn-left">
			         			<span class="l-btn-text icon-save l-btn-icon-left" style="padding-left: 20px; ">提交审核</span>
			         		</span>
			         	</a>
			         	<a id="radiation_edit_close" class="l-btn" href="javascript:void(0);" onclick="javascript:closeCurrentTab()">
			         		<span class="l-btn-left">
