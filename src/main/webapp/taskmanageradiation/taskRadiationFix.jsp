...
<script type="text/javascript">
	...
	function fixSubmit() {
		var submitForm = $('#taskOrderRadiation_FixForm');
		if (submitForm.form('validate')) {
			...
			$
					.ajax({
						type : "POST",
						url : '${pageContext.request.contextPath}/taskManageRadiation/fixComplete',
...
<div class="easyui-layout" data-options="fit : true,border : false">
	<div data-options="region:'center',border:false">
		<div align="center" style="margin-top:20px;">
			<form id="taskOrderRadiation_FixForm" method="post"
				...
				<table class="tasktableForm" width="95%" border="1"
					...
					<tr>
						...
						<td rowspan="15" width="380px">1、 电路名称一般以《详细规范》标题上的电路名称为准;<br />
					...
					<tr>
						...
						<td colspan="2"><input name="singleionsIndex"
							value=${taskOrder.singleionsIndex
							}
							style="width:100%;font-size: 12px" />
						</td>
					</tr>
					...
					<tr>
						<td colspan=4 style="text-align:center"><a
							id="radiation_fix_submit" class="l-btn"
							href="javascript:void(0);" onclick="javascript:fixSubmit()">
								<span class="l-btn-left"> <span
									class="l-btn-text icon-save l-btn-icon-left"
									style="padding-left: 20px; ">确认完成</span> </span> </a></td>
					</tr>
				</table>
			</form>
		</div>
