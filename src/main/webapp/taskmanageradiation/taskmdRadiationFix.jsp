...
<script type="text/javascript">
	...
	function fixSubmit(){
		var submitForm = $('#taskOrdermdRadiation_FixForm');
		if(submitForm.form('validate')){
    		...
    		$.ajax({
                type: "POST",
                url:'${pageContext.request.contextPath}/taskManagemdRadiation/fixComplete',
...
<div data-options="region:'center',border:false">
	<div align="center" style="margin-top:20px;">
		<form id="taskOrdermdRadiation_FixForm"method="post" enctype="multipart/form-data">
			...
			<table class="tasktableForm" width="95%" border="1"  bordercolor="#B5C0C4" rules="none" style="border-collapse:collapse;">
				...
				<tr>
			         <td colspan=4 style="text-align:center">
			         	<a id="radiation_fix_submit" class="l-btn" href="javascript:void(0);" onclick="javascript:fixSubmit()">
