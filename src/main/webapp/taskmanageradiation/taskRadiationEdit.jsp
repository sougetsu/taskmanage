...
<script type="text/javascript">
	...
	function editSubmit() {
		var submitForm = $('#taskOrderRadiation_EditForm');
		if (submitForm.form('validate')) {
			...
			$
					.ajax({
						type : "POST",
						url : '${pageContext.request.contextPath}/taskManageRadiation/editSubmit',
...
<div class="easyui-layout" data-options="fit : true,border : false">
	<div data-options="region:'center',border:false">
		<div align="center" style="margin-top:20px;">
			<form id="taskOrderRadiation_EditForm" method="post"
				...
				<table class="tasktableForm" width="95%" border="1"
					...
					<tr>
						...
						<td>单粒子 <span style="white-space:nowrap;"> <input
								...
								${taskOrder.singleionsFlag== 0 ? 'checked' : ''} />无 </span>
						</td>
						<td>总剂量 <span style="white-space:nowrap;"> <input
								...
								${taskOrder.totalDoseFlag== 0 ? 'checked' : ''} />无 </span>
						</td>
					</tr>
					<tr>
						<th>生产批次</th>
						<td><input name="singleionsBatch"
							value=${taskOrder.singleionsBatch } style="font-size: 12px" />
						</td>
						<td><input name="totalDoseBatch"
							value=${taskOrder.totalDoseBatch } style="font-size: 12px" />
						</td>
					</tr>
					<tr>
						<th>样品数量</th>
						<td><input name="singleionsSmpNum"
							value=${taskOrder.singleionsSmpNum } style="font-size: 12px" />
						</td>
						<td><input name="totalDoseSmpNum"
							value=${taskOrder.totalDoseSmpNum } style="font-size: 12px" />
						</td>
					</tr>
					<tr>
						<th>委托开发测试系统</th>
					...
					<tr>
						...
						<td colspan="2"><input name="microchipsVersion"
							value=${taskOrder.microchipsVersion
							}
							style="width:100%;font-size: 12px" />
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="2"><input name="singleionsIndex"
							value="<c:out value="${taskOrder.singleionsIndex}" escapeXml="true"/>"
							style="width:100%;font-size: 12px" />
					...
					<tr>
						...
						<td colspan="2"><input name="totalDoseIndex"
							value=${taskOrder.totalDoseIndex
							}
							style="width:100%;font-size: 12px" />
						</td>
					</tr>
					<tr>
						...
						<td colspan="2"><input name="entrustedUnits"
							value=${taskOrder.entrustedUnits
							}
							style="width:100%;font-size: 12px" />
						</td>
					</tr>
					<tr>
						...
						<td colspan="2"><input name="detailSpecification"
							value=${taskOrder.detailSpecification
							}
							style="width:100%;font-size: 12px" />
						</td>
					</tr>
					<tr>
						...
						<td colspan="2"><input type="checkbox" id="checkbox1"
							...
							name="detailSpecificationStatus" value="受控稿"${fn:contains(taskOrder.detailSpecificationStatus, '受控稿')? 'checked' : ''}><label
							style="vertical-align:middle;display:inline-block;font-size:12px;"
							for="checkbox1">受控稿</label> <input type="checkbox" id="checkbox2"
							style="vertical-align:middle;width:30px"
							name="detailSpecificationStatus" value="提前生产稿"${fn:contains(taskOrder.detailSpecificationStatus, '提前生产稿')? 'checked' : ''}><label
							style="vertical-align:middle;display:inline-block;font-size:12px;"
							for="checkbox2">提前生产稿</label> <input type="checkbox"
							id="checkbox3" style="vertical-align:middle;width:30px"
							name="detailSpecificationStatus" value="初稿"${fn:contains(taskOrder.detailSpecificationStatus, '初稿')? 'checked' : ''} ><label
							style="vertical-align:middle;display:inline-block;font-size:12px;"
							for="checkbox3">初稿</label> <input type="checkbox" id="checkbox4"
							style="vertical-align:middle;width:30px"
							name="detailSpecificationStatus" value="电路说明文件"${fn:contains(taskOrder.detailSpecificationStatus, '电路说明文件')? 'checked' : ''}><label
							style="vertical-align:middle;display:inline-block;font-size:12px;"
							for="checkbox4">电路说明文件</label></td>
					</tr>
					<tr>
						<th>用户单位</th>
						<td colspan="2"><input name="userUnits"
							value=${taskOrder.userUnits } style="width:100%;font-size: 12px" />
						</td>
					</tr>
					<tr>
						<th>工程型号</th>
						<td colspan="2"><input name="workModel"
							value=${taskOrder.workModel } style="width:100%;font-size: 12px" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input name="singleionsNo"
							value=${taskOrder.singleionsNo
							}
							style="width:100%;font-size: 12px" />
						</td>
						<td>提&nbsp;&nbsp;供&nbsp;&nbsp;人&nbsp;&nbsp;&nbsp;:<input
							name="testSampleSplMember"
							value=${taskOrder.testSampleSplMember
							}
					...
					<tr>
						...
						<td colspan="2"><input name="singleionsSpareNo"
							value=${taskOrder.singleionsSpareNo
							}
							style="width:100%;font-size: 12px" />
						</td>
							...
							<table width="100%">
								<tr>
									...
									<td><input name="productManager"
										value=${taskOrder.productManager
										}
										style="width:70%;font-size: 12px" />
									</td>
									<td>校对：</td>
					...
					<tr>
						<td colspan=4 style="text-align:center"><a
							id="radiation_edit_submit" class="l-btn"
							...
							id="radiation_edit_close" class="l-btn"
